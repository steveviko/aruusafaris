	 ...
	 <div class="col-md-4">
						<figure class="card card-product-grid">
							...
							<figcaption class="info-wrap" style="background:#CB5C21;font-family: Arial,Helvetica,sans-serif;font-weight:bolder;color:#ffffff;height: 350px;">
									<a href="#" class="title mb-2" style="color: #dee2e6;"><?php echo substr_replace(htmlentities($result->PackageName), "...", 17);?><br/><br/><?php echo substr_replace(htmlentities($result->PackageDetails), "...", 115);?></a>
