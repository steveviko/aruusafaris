...
<div class="form-row  mt-2 " >
		...
		<aside class="col-sm-12" style="background:#000;padding-bottom:10px;">
			...
			<div class="price-wrap">
					<span class="" style="color: #fff;padding:20px; text-transform:uppercase;">Our packages</span> 
...
<div class="row no-gutters">
	...
	<div class="home-category-banner " style="background:#489689;">
		...
		<a href="packages.php" class="btn btn-outline-primary rounded-pill">View All</a>
	 ...
	 <div class="col-md-4">
						<figure class="card card-product-grid">
							...
							<figcaption class="info-wrap" style="background:#CB5C21;font-family: Arial,Helvetica,sans-serif;font-weight:bolder;color:#ffffff;height: 350px;">
									<a href="#" class="title mb-2" style="color: #dee2e6;"><?php echo substr_replace(htmlentities($result->PackageName), "...", 40);?><br/><br/><?php echo substr_replace(htmlentities($result->PackageDetails), "...", 150);?></a>
